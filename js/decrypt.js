...
(function() {
  var bt, cHTMLK, cKeyT, cRowD, cRowP, cRowS, capl, chist, chkerr, chkuni, clearAllChilds, crpt, e, eform, exp, gKey, gProz, getBackground, getProzZ, hde, iKProz, iKVal, mField, rotk, rotm, rotp, schr, upKForm, whisto;
  ...
  chist = function() {
    ...
    for (_j = 0, _len1 = keys.length; _j < _len1; _j++) {
      c = keys[_j];
      this.keyProz[c] = this.keyProz[c] / count * 100;
    }
    this.writehisto();
    return false;
  };
